      ...
      <div className="py-3">
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          {comment.reply_count > 0 && replies.length === 0 && (
            <button onClick={handleLoadReplies} className="text-emerald-600 dark:text-emerald-400" disabled={loadingReplies}>
      ...
      {showReplyForm && (
        <div className="ml-6 mb-3">
          ...
          <div className="flex gap-2 mt-2">
            <button onClick={handleSubmitReply} className="px-3 py-1 bg-emerald-600 hover:bg-emerald-700 text-white rounded text-sm">
              Submit
            </button>
            <button
