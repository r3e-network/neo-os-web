      ...
      <div className="mb-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="0"
            min="1"
            className="flex-1 rounded-lg bg-white/20 px-4 py-2 text-white placeholder-green-200 dark:placeholder-gray-400 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
          />
          <button
            type="button"
            onClick={() => setAmount(userBalance)}
            aria-label="Set max stake amount"
            className="rounded-lg bg-white/20 px-3 py-2 text-sm hover:bg-white/30 transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
          >
            MAX
          </button>
        </div>
