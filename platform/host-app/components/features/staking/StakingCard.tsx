      ...
      <div className="mb-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="0"
            min="1"
            className="flex-1 rounded-lg bg-white/20 px-4 py-2 text-white placeholder-green-200 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/30"
          />
          <button
            type="button"
