      ...
      <div className="flex-1 min-w-0">
        ...
        {notification.tx_hash && (
          <a
            ...
            className="inline-block mt-2 cursor-pointer text-xs text-neo no-underline hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neo/50 rounded"
          >
            View Transaction →
          </a>
        )}
