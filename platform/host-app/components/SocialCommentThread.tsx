        ...
        >
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-red-500 hover:text-red-600 text-sm transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/50 rounded-lg"
            >
              Dismiss
            </button>
          </div>
      ...
      {canComment && (
        <div className="p-4 border-b border-gray-200">
          <textarea
            ...
            className="w-full border border-gray-200 bg-white text-gray-900 transition-colors resize-none placeholder-gray-400 rounded-xl p-3 focus-visible:border-neo/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neo/50"
            rows={3}
            maxLength={2000}
          />
          <button
            ...
            className="mt-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neo/50"
          >
