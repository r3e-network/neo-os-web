...
export function Footer() {
  return (
    <footer aria-label="Site footer" className="relative border-t border-gray-200 bg-white mt-20">
      <div className="mx-auto max-w-[1600px] px-6 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col items-start pr-0 lg:pr-10">
            <Link href="/" className="flex items-center gap-2 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 transition-transform hover:scale-105 inline-block">
          ...
          {/* Platform Links */}
          <div>
            <h3 className="text-sm font-black uppercase tracking-widest text-gray-900 mb-6">Platform</h3>
            <ul className="space-y-4">
              {footerLinks.platform.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm font-medium text-gray-500 hover:text-emerald-600 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-md inline-block">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Resources Links */}
          <div>
            <h3 className="text-sm font-black uppercase tracking-widest text-gray-900 mb-6">Resources</h3>
            <ul className="space-y-4">
          ...
          {/* Community Links */}
          <div>
            <h3 className="text-sm font-black uppercase tracking-widest text-gray-900 mb-6">Community</h3>
            <ul className="space-y-4">
        ...
        <div className="mt-16 border-t border-gray-200 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/terms" className="text-sm font-medium text-gray-400 hover:text-gray-700 transition-colors">Terms of Service</Link>
            <Link href="/privacy" className="text-sm font-medium text-gray-400 hover:text-gray-700 transition-colors">Privacy Policy</Link>
          </div>
        </div>
      </div>
    </footer>
