export default function Custom404() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 text-gray-800 dark:bg-gray-950 dark:text-gray-200">
      <div className="p-8 text-center">
        <h1 className="m-0 text-7xl font-bold text-neo">404</h1>
        <p className="my-4 text-lg text-gray-500 dark:text-gray-400">Page not found</p>
        <a
          href="/"
