...
export default function LaunchPage({ app }: LaunchPageProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black overflow-hidden">
      ...
      {toastMessage && <div role="status" aria-live="polite" className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-neo/90 text-black px-6 py-3 rounded-lg font-semibold text-sm z-[60]">{toastMessage}</div>}
