...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    logger.warn("miniapp-notifications upstream request failed:", err instanceof Error ? err.message : "unknown error");
  ...
  try {
    ...
    logger.warn("miniapp-notifications invalid upstream response:", err instanceof Error ? err.message : "unknown error");
