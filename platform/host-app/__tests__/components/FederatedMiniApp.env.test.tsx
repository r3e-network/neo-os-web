...
describe("FederatedMiniApp env access", () => {
  ...
  it("reads NEXT_PUBLIC_MF_REMOTES lazily at render time", () => {
    ...
    const { FederatedMiniApp } = require("../../components/FederatedMiniApp") as typeof import("../../components/FederatedMiniApp");

    process.env.NEXT_PUBLIC_MF_REMOTES = "miniapp=https://remote.example";

    const html = renderToString(React.createElement(FederatedMiniApp, { remote: "miniapp" }));
