  ...
  return (
    <div className="hidden h-screen w-64 shrink-0 flex-col bg-[#05050A] border-r border-white/5 shadow-2xl relative overflow-hidden md:flex">
      ...
      <div className="flex h-16 items-center px-6 relative z-10">
        <h1 className="text-xl font-bold text-white bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 drop-shadow-sm">
          {ta("dashboard.title")}
        </h1>
      </div>
      <nav
        aria-label="Admin navigation"
        className="flex-1 px-4 py-6 relative z-10"
      >
                ...
                >
                  <span
                    className={cn(
                      "text-lg",
                      isActive
                        ? "drop-shadow-[0_0_8px_rgba(0,229,153,0.5)]"
                        : "",
                    )}
                    aria-hidden="true"
                  >
