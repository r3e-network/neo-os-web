    ...
    <div className="flex border-b border-gray-200 dark:border-gray-700 gap-0">
      {tabs.map((t) => (
        <button
          ...
          className={`px-4 py-2 text-sm font-medium border-b-2 -mb-px transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-600/50 ${
            value === t.value
