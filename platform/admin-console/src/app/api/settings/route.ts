...
export async function GET(request: Request) {
  ...
  return NextResponse.json({ _mock: true, config: platformConfig }, { headers: { "X-Mock-Data": "true" } });
}
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ _mock: true, success: true, config: platformConfig }, { headers: { "X-Mock-Data": "true" } });
  } catch (error) {
