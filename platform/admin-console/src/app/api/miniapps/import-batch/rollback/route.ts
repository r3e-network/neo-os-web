...
export async function POST(req: Request) {
  ...
  return proxyToHost(req, {
    hostAppBaseURL,
    path: "/api/miniapps/admin/import-batch-rollback",
    method: "POST",
    body: payload,
    timeoutMs: HOST_PROXY_TIMEOUTS.SHORT,
    notOkError: "Batch rollback failed",
    fallbackError: "Failed to reach host-app batch rollback endpoint",
    logLabel: "[import-batch/rollback]",
  });
}
