...
export async function GET(req: Request) {
  ...
  return proxyToHost(req, {
    hostAppBaseURL,
    path: "/api/miniapps/admin/template-catalog",
    timeoutMs: HOST_PROXY_TIMEOUTS.STANDARD,
    notOkError: "Failed to load template catalog",
    fallbackError: "Failed to reach host-app template catalog endpoint",
    logLabel: "[admin/template-catalog]",
  });
}
