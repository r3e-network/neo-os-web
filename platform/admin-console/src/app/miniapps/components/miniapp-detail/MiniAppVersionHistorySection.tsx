...
import type { DiffScope, DiffSummary, VersionChannel, VersionsQueryLike } from "./types";
          ...
          {versionsQuery.data.versions.map((version) => (
            <div key={version.id} className="flex items-center gap-3 px-3 py-2 text-xs">
              ...
              <span className="ml-auto flex items-center gap-2">
                ...
                <Button size="sm" variant="ghost" onClick={() => onSelectDiffVersion(version.id)}>
                  Diff
                </Button>
                <Button size="sm" variant="ghost" onClick={() => onRollbackVersion(version)} disabled={rollbackPending}>
                  Rollback
                </Button>
              </span>
            </div>
        ...
        <div className="mt-3 rounded-lg border border-gray-200 p-3 dark:border-gray-700">
          <div className="mb-2 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" variant="ghost" onClick={onExportCurrentDiffCsv}>
                Export CSV
              </Button>
