    ...
    <div className="flex items-center justify-between">
      <div>
        ...
        <div className="mt-2 flex flex-wrap items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
          <span className="font-medium uppercase text-gray-400 dark:text-gray-500">
            Ops
          </span>
          {links.map((link) => (
            <a
        ...
        {templateInstallInfo && (
          <p className="mt-2 text-sm text-info-600 dark:text-info-400">
            {templateInstallInfo}
          </p>
        )}
        {importResultText && (
        ...
        {rollbackPlanCount > 0 ? (
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
            Rollback plan ready: {rollbackPlanCount} target(s)
          </p>
        ) : null}
      </div>
      <div className="flex flex-wrap justify-end gap-2">
        <button
          type="button"
          className="inline-flex cursor-pointer items-center rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-800"
        ...
        <Button
          variant="secondary"
          disabled={importBatchPending || batchFilesCount === 0}
        ...
        <Button
          variant="secondary"
          disabled={rollbackBatchPending || !canRollbackBatch}
        ...
        <Button
          variant="secondary"
          disabled={importDefinitionsPending}
