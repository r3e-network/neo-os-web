  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <Input
          label="Entry URL *"
          placeholder="mf://manifest?app=com.example.myapp"
          value={form.entry_url}
          onChange={(e) => update("entry_url", e.target.value)}
        />
        <Input
          label="Version"
          placeholder="1.0.0"
      ...
      <div className="grid grid-cols-2 gap-4">
        <Input
          ...
          onChange={(e) => update("developer_user_id", e.target.value)}
        />
        <Input
          label="Developer Pubkey (hex)"
          placeholder="03f35d..."
          value={form.developer_pubkey}
          onChange={(e) => update("developer_pubkey", e.target.value)}
        />
        <div className="flex items-end">
          <label className="flex items-center gap-2 text-sm pb-2">
            <input
              ...
              onChange={(e) => update("attestation_required", e.target.checked)}
      ...
      <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <Input
            ...
            onChange={(e) => update("frontend_template_id", e.target.value)}
          />
          <Input
            label="Frontend Version"
            placeholder="1.0.0"
            value={form.frontend_template_version}
            onChange={(e) =>
              update("frontend_template_version", e.target.value)
            }
          />
          <Input
            label="Frontend Variant"
            placeholder="market-modern"
            value={form.frontend_template_variant}
            onChange={(e) =>
              update("frontend_template_variant", e.target.value)
            }
          />
        </div>
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              update("frontend_template_params_json", e.target.value)
            }
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          <Input
            ...
            onChange={(e) => update("contract_template_id", e.target.value)}
          />
          <Input
            label="Contract Version"
            placeholder="1.2.0"
            value={form.contract_template_version}
            onChange={(e) =>
              update("contract_template_version", e.target.value)
            }
          />
          <Input
            label="Contract Variant"
            placeholder="oracle-required"
            value={form.contract_template_variant}
            onChange={(e) =>
              update("contract_template_variant", e.target.value)
            }
          />
          <Input
            label="Factory Template Ref"
            placeholder="factory.prediction.v2"
            value={form.contract_template_factory_ref}
            onChange={(e) =>
              update("contract_template_factory_ref", e.target.value)
            }
          />
        </div>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <Input
            ...
            onChange={(e) =>
              update("contract_template_requires_capabilities", e.target.value)
            }
          />
          <Input
            ...
            onChange={(e) =>
              update("contract_template_min_factory_version", e.target.value)
            }
          />
          <Input
            ...
            onChange={(e) =>
              update("contract_template_max_factory_version", e.target.value)
            }
          />
        </div>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                update("contract_template_init_params_json", e.target.value)
              }
              placeholder={`{\n "oracle": "0x...",\n "fee_bps": 100\n}`}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                update("contract_template_init_schema_json", e.target.value)
              }
              placeholder={`{\n "type": "object",\n "required": ["oracle"]\n}`}
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                update("contract_template_method_schema_json", e.target.value)
              }
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <Input
            ...
            onChange={(e) =>
              update("contract_template_audit_provider", e.target.value)
            }
          />
          <Input
            label="Audit Hash"
            ...
            onChange={(e) =>
              update("contract_template_audit_hash", e.target.value)
            }
          />
          <Input
            label="Audit Date"
            ...
            onChange={(e) =>
              update("contract_template_audit_date", e.target.value)
            }
          />
        </div>
      </div>
