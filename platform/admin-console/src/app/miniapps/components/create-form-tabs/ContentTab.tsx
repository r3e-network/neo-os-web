  ...
  return (
    <div className="space-y-4">
      <textarea
        ...
        onChange={(e) => update("content_description", e.target.value)}
      ...
      <div className="grid grid-cols-3 gap-4">
        <Input
          label="Icon URL"
          placeholder="https://..."
          value={form.content_icon_url}
          onChange={(e) => update("content_icon_url", e.target.value)}
        />
        <Input
          label="Logo URL"
          placeholder="https://..."
          value={form.content_logo_url}
          onChange={(e) => update("content_logo_url", e.target.value)}
        />
        <Input
          label="Banner URL"
          placeholder="https://..."
          value={form.content_banner_url}
      ...
      <div className="grid grid-cols-3 gap-4">
        <Input
          ...
          value={form.content_docs_url}
          onChange={(e) => update("content_docs_url", e.target.value)}
        />
        <div>
          <label
        ...
        <Input
          ...
          placeholder="game,defi"
          value={form.content_tags}
          onChange={(e) => update("content_tags", e.target.value)}
        />
      </div>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              update("content_logo_variants_json", e.target.value)
            }
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              update("content_banner_variants_json", e.target.value)
            }
      ...
      <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-3 space-y-3">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
          {(["icon", "logo", "banner"] as MiniAppMediaAssetKind[]).map(
            (assetType) => {
              const variantAssetType: "logo" | "banner" | null =
                assetType === "logo" || assetType === "banner"
                  ? assetType
                  : null;
              const variantSettings = variantAssetType
                ? assetVariantSettings[variantAssetType]
                : null;
              return (
                <div
                  key={assetType}
                        ...
                        <select
                          ...
                          onChange={(event) =>
                            updateAssetVariantSettings(variantAssetType, {
                              theme: event.target
                                .value as AssetVariantSettings["theme"],
                            })
                          }
                          ...
                          onChange={(event) =>
                            updateAssetVariantSettings(variantAssetType, {
                              density: event.target
                                .value as AssetVariantSettings["density"],
                            })
                          }
