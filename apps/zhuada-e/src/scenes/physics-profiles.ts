...
const FARM: readonly ItemPhysicsProfile[] = [
  ...
  profile(0.62, "ceramic", 0.96, [cylinder(0.62, 0.44)], undefined, 0.92),
  ...
  profile(0.72, "ceramic", 0.9, [cylinder(0.47, 0.72), box([0.18, 0.27, 0.14], [0.48, 0, 0])], undefined, 0.72),
  profile(0.62, "wood", 1.08, [cylinder(0.22, 1.25, undefined, [0, 0, Math.PI / 2])], undefined, 1.2),
  profile(1.05, "metal", 1.08, [cylinder(0.62, 0.55), box([0.72, 0.12, 0.18], [0, 0.12, 0])], undefined, 1.18),
...
const NIGHT: readonly ItemPhysicsProfile[] = [
  profile(0.44, "paper", 1.02, [cylinder(0.48, 0.9)], [0.12, 0.2], 1.16),
  profile(0.36, "paper", 0.88, [sphere(0.6)], [0.13, 0.22], 0.66),
  profile(0.76, "metal", 0.92, [cylinder(0.43, 0.98)], [0.05, 0.1], 0.78),
