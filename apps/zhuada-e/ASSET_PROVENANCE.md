...
variants and transparent per-object runtime textures. It also owns 18 original
SVG recipes for the six catalog extensions in each theme (strawberry basket to
juice carton, rolling pin to yarn, and teapot to mahjong). Those recipes are
code-native project assets rather than extracted media. Generated runtime files
...
checks the expected dimensions for 78 public images, requires alpha on all 54
