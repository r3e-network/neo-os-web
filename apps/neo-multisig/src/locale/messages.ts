...
const appMessages = {
  ...
  multisigHeroSubtitle: {
    ...
    zh: "准备 Neo 共享交易，追踪签名阈值，并在钱包确认前清楚展示广播准备状态。",
  },
  multisigPendingMetric: { en: "Pending", zh: "待处理" },
  multisigCompletedMetric: { en: "Completed", zh: "已完成" },
  ...
  multisigRouteCopy: {
    en: "Every transaction moves through request creation, signer approval, then final broadcast once the threshold is met.",
    zh: "每笔交易先创建请求，再收集签名，达到阈值后才进入最终广播。",
  },
  multisigSignerTitle: { en: "Signer controls", zh: "签名人控制" },
  multisigSignerCopy: {
  ...
  multisigBroadcastTitle: { en: "Broadcast", zh: "广播" },
  multisigWalletReviewed: { en: "Wallet reviewed", zh: "钱包确认" },
  multisigFeeGuard: { en: "Pre-check", zh: "预检查" },
  multisigRouteCreate: { en: "Build request", zh: "创建请求" },
  multisigRouteSign: { en: "Collect signatures", zh: "收集签名" },
