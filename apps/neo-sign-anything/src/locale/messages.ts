...
const appMessages = {
  ...
  signingNow: { en: "Signing...", zh: "签名中..." },
  broadcastBtn: { en: "Broadcast Message (On-chain)", zh: "广播信息 (上链)" },
  broadcastShort: { en: "Broadcast", zh: "广播" },
  broadcastingNow: { en: "Broadcasting...", zh: "广播中..." },
  ...
  signFileShort: { en: "Load file", zh: "载入文件" },
  proofDetails: { en: "Proof details", zh: "证明详情" },
  proofTabSafety: { en: "Safety", zh: "安全" },
  proofTabSignature: { en: "Signature", zh: "签名" },
  proofTabBroadcast: { en: "Broadcast", zh: "广播" },
  hashedFileNotice: {
