...
const appMessages = {
  ...
  agentTopologyTitle: { en: "21-agent trust topology", zh: "21 Agent 信任拓扑" },
  agentTopologySubtitle: {
    en: "Every assurance and voting route, visible at once",
    zh: "所有信任与投票路由，一图可见",
  },
  ...
  topologyNetworkLabel: {
    en: "Selectable TrustAnchor AA-agent route topology",
    zh: "可选择的 TrustAnchor AA agent 路由拓扑",
  },
  topologyLegendLabel: { en: "Topology legend", zh: "拓扑图例" },
  sourceLegend: { en: "Source", zh: "来源" },
  targetLegend: { en: "Target", zh: "目标" },
  activeRouteLegend: { en: "Trusted route", zh: "可信路由" },
  inactiveRouteLegend: { en: "Inactive", zh: "未启用" },
  anchorHubTitle: { en: "TrustAnchor assurance hub", zh: "TrustAnchor 信任中枢" },
  routePlannerTitle: { en: "Trust route planner", zh: "信任路由规划器" },
  ...
  rosterUnverifiedBody: {
    en: "The configured trust topology remains visible for diagnosis, but transactions stay locked until a live on-chain roster is verified.",
    zh: "配置信任拓扑会保留用于排查，但在链上实时名册验证成功前，交易保持锁定。",
  },
  ...
  selectedRoutePlanner: { en: "Selected trust route", zh: "已选信任路由" },
  ...
  agentStatus: { en: "Trust-route status", zh: "信任路由状态" },
  transactionPreview: { en: "Transaction preview", zh: "交易预览" },
  operationRetryHint: {
    en: "The transaction was not submitted. Your trust route is preserved; review the wallet notice and try again.",
    zh: "交易未提交。当前信任路由已保留，请查看钱包提示后重试。",
  },
  ...
  operationsAndDirectory: { en: "Trust-route details", zh: "信任路由详情" },
