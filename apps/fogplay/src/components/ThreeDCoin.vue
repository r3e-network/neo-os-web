...
<template>
  <div class="coin-scene">
    <div class="coin-container" :class="{ flipping: flipping }" :style="coinStyle">
      <!-- Front Face (Heads / NEO) - Generated by Gemini Banana -->
      <div class="coin-face front">
        <img src="@/static/coin_heads.png" class="coin-img" aria-hidden="true" />
      </div>

      <!-- Back Face (Tails / GAS) - Generated by Gemini Banana -->
      <div class="coin-face back">
        <img src="@/static/coin_tails.png" class="coin-img" aria-hidden="true" />
      </div>
    </div>
    
    <!-- Floor Shadow -->
    <div class="coin-shadow" :class="{ 'is-flipping': flipping }" />
  </div>
</template>
