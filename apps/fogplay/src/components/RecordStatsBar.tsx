...
export default function RecordStatsBar({ t, wins, losses, totalGames }: RecordStatsBarProps) {
  ...
  return (
    <div className="record-bar">
      <div className="record-item win"><span className="record-mark" aria-hidden="true">W</span><span className="record-count">{wins}</span><span className="record-label">{t("wins")}</span></div>
      ...
      <div className="record-divider" />
      <div className="record-item loss"><span className="record-mark" aria-hidden="true">L</span><span className="record-count">{losses}</span><span className="record-label">{t("losses")}</span></div>
      <div className="record-divider" />
