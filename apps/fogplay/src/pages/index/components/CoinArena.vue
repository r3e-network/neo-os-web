<template>
  <div class="premium-arena">
    <div class="arena-content">
      <!-- High-End Background Decoration -->
      <div class="arena-bg">
        <div class="arena-orbit" />
        <div class="arena-glow" :class="{ flipping: isFlipping }" />
      </div>

      <!-- Holo Pedestal Base - Generated by Gemini Banana -->
      <img src="@/static/holo_pedestal.png" class="holo-pedestal" :alt="t('pedestalDecoration')" />
      ...
      <div class="status-box">
        <div class="game-status-pill">
          <div class="status-dot" :class="{ flipping: isFlipping }" />
