...
const appMessages = {
  ...
  revealingNextBlock: { en: "Revealing next block...", zh: "下一区块揭晓中..." },
  betPlacedRevealing: {
  ...
  feature1Desc: { en: "A commit/reveal flip: the outcome is drawn from a later block's randomness, so it can't be peeked or aborted on a loss.", zh: "采用「提交—揭晓」抛掷：结果取自更晚区块的随机数，无法被窥探或在将输时中止。" },
