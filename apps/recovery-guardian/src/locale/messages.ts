...
const appMessages = {
  ...
  guardianCommandStageLabel: {
    en: "Guardian account scan route",
    zh: "Guardian 账户扫描路径",
  },
  guardianCommandStageEyebrow: {
    en: "Account scan",
    zh: "账户扫描",
  },
  guardianStageIdle: {
    en: "Choose an account to inspect",
    zh: "选择要检查的账户",
  },
  guardianStageIdleHint: {
    en: "Paste a Neo address or Hash160, then run the scan before preparing recovery.",
    zh: "粘贴 Neo 地址或 Hash160，然后先运行扫描再准备恢复。",
  },
  guardianStageArmed: {
    en: "Ready to read guardian state",
    zh: "已准备读取 Guardian 状态",
  },
  guardianStageArmedHint: {
    en: "The account locator is valid. Query state to inspect verifier, owner, and timelock.",
    zh: "账户定位符有效。查询状态以检查 verifier、owner 与锁定期。",
  },
  guardianStageQuerying: {
    en: "Reading guardian boundary",
    zh: "正在读取 Guardian 边界",
  },
  guardianStageQueryingHint: {
    en: "Fetching the account recovery boundary before any handoff link is enabled.",
    zh: "正在获取账户恢复边界；完成前不会启用任何交接链接。",
  },
  guardianStageReady: {
    en: "State loaded, prepare handoff",
    zh: "状态已加载，准备交接",
  },
  guardianStageReadyHint: {
    en: "Review the account state, then complete the owner and expiry pass.",
    zh: "检查账户状态，然后完成 owner 与过期时间 pass。",
  },
  guardianRouteAccount: { en: "Account", zh: "账户" },
  guardianRouteAccountReady: { en: "Valid", zh: "有效" },
  guardianRouteAccountNeeded: { en: "Needed", zh: "需要" },
  guardianRouteState: { en: "State", zh: "状态" },
  guardianRouteStateWaiting: { en: "Waiting", zh: "等待" },
  guardianRouteStateReading: { en: "Reading", zh: "读取中" },
  guardianRouteStateReady: { en: "Loaded", zh: "已加载" },
  guardianRouteHandoff: { en: "Handoff", zh: "交接" },
  guardianRouteLinksReady: { en: "Ready", zh: "就绪" },
  guardianRouteLinksLocked: { en: "Locked", zh: "锁定" },
  accountAddressHint: {
  ...
  guardianPassDraft: { en: "Complete fields", zh: "补齐字段" },
  guardianPassReady: { en: "Links ready", zh: "链接就绪" },
  guardianPassOwner: { en: "Owner", zh: "Owner" },
  guardianPassOwnerReady: { en: "Ready", zh: "就绪" },
  guardianPassOwnerMissing: { en: "Missing", zh: "缺失" },
  guardianPassExpiry: { en: "Expiry", zh: "过期" },
  guardianPassExpiryReady: { en: "Ready", zh: "就绪" },
  guardianPassExpiryMissing: { en: "Invalid", zh: "无效" },
  guardianPassVerifier: { en: "Verifier", zh: "Verifier" },
  guardianPassVerifierAuto: { en: "Auto", zh: "自动" },
  guardianPassVerifierCustom: { en: "Custom", zh: "自定义" },
  guardianPassVerifierInvalid: { en: "Invalid", zh: "无效" },
  newOwnerHint: {
  ...
  queryingState: { en: "Querying state...", zh: "正在查询状态..." },
