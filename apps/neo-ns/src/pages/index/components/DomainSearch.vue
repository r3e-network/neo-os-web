  ...
  >
    <div class="result-header">
      <div class="domain-title-row">
        <span class="result-domain">{{ localQuery }}.neo</span>
        <span v-if="localQuery.length <= 3" class="premium-badge">{{ t("premium") }}</span>
      </div>
      <span
    ...
    <div v-if="searchResult.available" class="result-body">
