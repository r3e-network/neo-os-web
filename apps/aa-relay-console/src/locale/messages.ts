...
const appMessages = {
  ...
  relayBoardChecking: { en: "Checking paymaster coverage for this account.", zh: "正在检查该账户的 paymaster 覆盖情况。" },
  relayBoardRelaying: { en: "Relayer is broadcasting the validated payload.", zh: "Relayer 正在广播已校验的 payload。" },
  relayBoardSubmitted: { en: "Relay response received. Verify the returned transaction state.", zh: "已收到 relay 响应。请验证返回的交易状态。" },
  relayBoardAA: { en: "AA account", zh: "AA 账户" },
  relayBoardPaymaster: { en: "Paymaster", zh: "Paymaster" },
  relayBoardPayload: { en: "Payload", zh: "Payload" },
