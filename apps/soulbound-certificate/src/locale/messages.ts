...
const appMessages = {
  ...
  issueLinkShared: { en: "Issue link shared", zh: "签发链接已分享" },
  ...
  recentLinksTitle: { en: "Recent Issue Links", zh: "最近签发链接" },
  recentLinksEmpty: { en: "No recent issue links yet", zh: "还没有最近签发链接" },
  openLink: { en: "Open Link", zh: "打开链接" },
  reuseTemplate: { en: "Reuse Template", zh: "复用模板" },
