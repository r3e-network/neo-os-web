...
.certificate-play-area { display: flex; flex-direction: column; gap: 20px; padding: 20px 12px; min-height: 300px; }
.hero-container { margin-bottom: 20px; background: radial-gradient(ellipse at 50% 40%, rgba(159, 157, 243, 0.08) 0%, transparent 55%); }
...
.hero-stat-value { display: block; font-size: 20px; font-weight: 800; color: var(--text-primary); }
