...
const appMessages = {
  ...
  passportTemplateTitle: { en: "Credential purpose", zh: "凭证用途" },
  passportTemplateReady: { en: "Credential purpose selected", zh: "凭证用途已选择" },
  passportTemplateWallet: { en: "Wallet ownership", zh: "钱包所有权" },
  passportTemplateWalletHint: {
    en: "Prove this DID controls the wallet used by OneGate.",
    zh: "证明此 DID 控制 OneGate 使用的钱包。",
  },
  passportTemplateRelying: { en: "Relying-party access", zh: "依赖方访问" },
  passportTemplateRelyingHint: {
    en: "Prepare an access passport for another miniapp.",
    zh: "为另一个小程序准备访问护照。",
  },
  passportTemplateDeveloper: { en: "Developer pass", zh: "开发者通行证" },
  passportTemplateDeveloperHint: {
    en: "Package an oracle or tool developer credential.",
    zh: "打包预言机或工具开发者凭证。",
  },
  passportCustomCredential: { en: "Custom credential", zh: "自定义凭证" },
  advancedFieldsTitle: { en: "Advanced credential fields", zh: "高级凭证字段" },
  advancedFieldsCopy: {
    en: "Use these only when a relying party asks for exact DID, claim, or audience values.",
    zh: "仅在依赖方要求精确 DID、声明或受众值时使用。",
  },
  passportActionsTitle: { en: "Passport actions", zh: "护照操作" },
  passportActionsCopy: {
    en: "Build the payload first, then attach a wallet proof when needed.",
    zh: "先构建载荷，再按需附加钱包证明。",
  },
