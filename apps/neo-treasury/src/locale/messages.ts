...
const appMessages = {
  ...
  treasuryPendingHint: { en: "The dashboard stays read-only while the RPC balance read completes.", zh: "RPC 余额读取期间，仪表盘保持只读。" },
  treasurySyncedHint: { en: "Totals are assembled from public NEO and GAS balances.", zh: "总额由公开 NEO 与 GAS 余额汇总。" },
  treasuryReadOnlyRoute: { en: "Read-only monitor route", zh: "只读监控路径" },
