...
const appMessages = {
  ...
  treasuryFlowTitle: { en: "Treasury payout route", zh: "国库支出路径" },
  treasuryFlowSubtitle: {
    en: "Review the source wallet, asset, recipient, and signing state before the wallet opens.",
    zh: "在打开钱包前核查来源钱包、资产、收款人和签名状态。",
  },
