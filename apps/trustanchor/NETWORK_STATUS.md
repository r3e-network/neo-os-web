# TrustAnchor Network Status

Read-only verification date: 2026-07-12

| Network | RPC | PlatformAnchor | Contract name | App mode | Paused | Agent count |
| --- | --- | --- | --- | --- | --- | --- |
| Neo N3 mainnet | `https://mainnet2.neo.coz.io:443` | `0x02beeef6f65c6989a121c0a0e6b23190333edb98` | `PlatformAnchor` | `1` | `false` | `21` |
| Neo N3 testnet | `https://testnet1.neo.coz.io:443` | `0xab079b4f9a0a2471d136392e25eb8e99898dcad0` | `PlatformAnchor` | `1` | `false` | `21` |
