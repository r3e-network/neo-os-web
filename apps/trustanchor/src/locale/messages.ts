...
const appMessages = {
  ...
  heroDescription: {
    en: "TrustAnchor is a manual 21-agent AA routing desk. Operators move NEO between candidate agents and sync votes explicitly.",
    zh: "TrustAnchor 是手动的 21 个 AA agent 路由台。运营方在候选人 agent 之间移动 NEO，并显式同步投票。",
  },
