<template>
  <NeoCard>
    ...
    <div v-else>
      <div class="info-row">
        <span class="info-label">{{ t("walletAddress") }}</span>
        <span class="info-value mono">{{ shortenAddress(userAddress) }}</span>
      </div>
      <div class="info-row">
      ...
      <div class="info-row">
        ...
        <span :class="['info-value', 'badge', isEligible ? 'eligible' : 'not-eligible']">
