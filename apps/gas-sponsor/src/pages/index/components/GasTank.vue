    ...
    <div class="gas-tank-container">
      <div class="gas-tank">
        ...
        <div class="tank-graduations">
          <div class="graduation-mark mark-20"></div>
          <div class="graduation-mark mark-40"></div>
          <div class="graduation-mark mark-60"></div>
          <div class="graduation-mark mark-80"></div>
        </div>

        <div class="tank-body">
          <div class="fuel-level" :style="{ height: fuelLevelPercent + '%' }">
            <div class="fuel-surface"></div>
            <!-- Bubbles for liquid effect -->
            <div class="fuel-bubble b1"></div>
            <div class="fuel-bubble b2"></div>
            <div class="fuel-bubble b3"></div>
          </div>
