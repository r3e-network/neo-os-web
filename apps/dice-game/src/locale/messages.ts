...
const appMessages = {
  ...
  fairnessNote: {
    en: "Your wager commits first; the roll is revealed from a later block, so neither side can know the result when the bet is placed.",
    zh: "下注先提交，掷骰结果来自更晚区块，因此下注时双方都无法提前知道结果。",
  },
  fairnessShort: {
    en: "The bet commits first; a later block reveals the die.",
    zh: "下注先提交，再由后续区块揭晓骰子。",
  },
  rulesShort: {
