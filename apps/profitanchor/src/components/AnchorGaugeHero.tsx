/**
 * AnchorGaugeHero.tsx -- Hero gauge display for ProfitAnchor.
 */
        ...
        <svg viewBox="0 0 200 120" className="gauge-svg">
          ...
          <defs>
            <linearGradient id="gaugeGrad" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="var(--profitanchor-emerald-light, #34d399)" />
              <stop offset="100%" stopColor="var(--profitanchor-emerald, #10b981)" />
            </linearGradient>
          </defs>
        </svg>
