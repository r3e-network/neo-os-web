...
title: { en: "Breakup Contract", zh: "分手合约" },
  ...
  builderTitle: { en: "Build the pact before the wallet prompt", zh: "先复核约定，再唤起钱包" },
  ...
  pactPreviewRule: { en: "If the pact is honored, both stakes can be refunded. If one side breaks it, that side forfeits their stake.", zh: "如约履行则双方可退回质押；若一方违约，该方质押将被罚没。" },
