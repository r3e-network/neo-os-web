...
const appMessages = {
  ...
  bridgeStageIntent: { en: "Intent", zh: "意图" },
  bridgeStageTarget: { en: "Target", zh: "目标" },
  bridgeStagePreparing: { en: "Preparing handoff", zh: "正在准备交接" },
  bridgeStageReady: { en: "Route ready", zh: "路径就绪" },
  bridgeStageWaiting: { en: "Awaiting details", zh: "等待补全信息" },
