<template>
  <div class="tab-content scrollable">
    <div class="history-header">
      <span class="history-label">{{ t("recentDestructions") }}</span>
    ...
    <div v-else class="history-list">
      ...
      >
        <div class="history-item-content">
          ...
          <div :class="['history-badge', { forgotten: item.forgotten }]">
            <span class="badge-text">{{ item.forgotten ? t("forgotten") : t("destroyed") }}</span>
          </div>
          <NeoButton
            v-if="!item.forgotten"
            size="sm"
