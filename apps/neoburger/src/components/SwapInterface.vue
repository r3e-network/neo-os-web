<template>
  <div class="swap-panel">
    <div class="swap-block">
      <div class="swap-row">
        <span class="swap-label">{{ t("from") }}</span>
      ...
      <div class="swap-input">
        <div class="swap-asset">
          ...
          />
          <span class="swap-asset-label">{{ swapMode === "stake" ? t("tokenNeo") : t("tokenBneo") }}</span>
        </div>
        <NeoInput
    ...
    <button type="button" class="swap-toggle" :aria-label="t('swapToggleAlt')" @click="emit('toggleMode')">
      <img
    ...
    <div class="swap-block">
      <div class="swap-row">
        <span class="swap-label">{{ t("to") }}</span>
        <span class="swap-hint">{{ t("estimatedOutput") }}</span>
      </div>
      <div class="swap-output">
        <div class="swap-asset">
          ...
          />
          <span class="swap-asset-label">{{ swapMode === "stake" ? t("tokenBneo") : t("tokenNeo") }}</span>
        </div>
        <span class="swap-output-value">{{ swapOutput }}</span>
      </div>
    </div>
  </div>
</template>
