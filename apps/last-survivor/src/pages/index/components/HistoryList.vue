    ...
    >
      <template #item="{ item }">
        <div class="history-header">
          <span class="history-title-glass">{{ (item as unknown as HistoryEvent).title }}</span>
          <span class="history-date-glass">{{ (item as unknown as HistoryEvent).date }}</span>
        </div>
        <span class="history-desc-glass">{{ (item as unknown as HistoryEvent).details }}</span>
      </template>
    </ItemList>
  </NeoCard>
</template>
