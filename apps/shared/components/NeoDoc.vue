<template>
  <div class="neo-doc" role="article" :aria-label="title">
    ...
    <div class="doc-content">
      <div class="doc-section">
        <ScrollReveal animation="fade-up" :delay="200">
          <span class="section-label" role="heading" aria-level="3">{{ t("docWhatItIs") }}</span>
    ...
    <div class="doc-footer">
      <ScrollReveal animation="fade-up" :delay="800">
        <span class="footer-text">{{ t("docFooter") }}</span>
      </ScrollReveal>
    </div>
  </div>
</template>
