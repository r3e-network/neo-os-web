<template>
  ...
  >
    <div ref="contentRef" class="neo-modal__content" :class="`neo-modal--${variant}`">
      <div v-if="title" class="neo-modal__header">
        <span :id="`${modalId}-title`" class="neo-modal__title">{{ title }}</span>
        <div
          v-if="closeable"
      ...
      <div v-if="$slots.footer" class="neo-modal__footer">
        <slot name="footer" />
      </div>
    </div>
  </div>
