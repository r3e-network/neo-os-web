  ...
  <div class="form-card" role="form" :aria-label="title || t('formLabel')">
    <div v-if="title || description" class="form-card__header">
      <div class="form-card__header-text">
        ...
        <span v-if="description" class="form-card__description">{{ description }}</span>
      </div>
    ...
    <!-- Validation error -->
    <div v-if="error" class="form-card__error" role="alert">
      <span class="form-card__error-text">{{ error }}</span>
    </div>
