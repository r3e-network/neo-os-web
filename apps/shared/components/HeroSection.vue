<template>
  ...
  >
    ...
    <div class="hero-section__content">
      <span v-if="icon" class="hero-section__icon" aria-hidden="true">{{ icon }}</span>

      <span v-if="subtitle" class="hero-section__subtitle">{{ subtitle }}</span>
      <span v-if="title" class="hero-section__title">{{ title }}</span>
      <span v-if="suffix" class="hero-section__suffix">{{ suffix }}</span>

      <div v-if="description" class="hero-section__description">
        <span>{{ description }}</span>
      </div>

      <div v-if="$slots.stats" class="hero-section__stats">
        <slot name="stats" />
      </div>

      <div v-if="$slots.actions" class="hero-section__actions">
        <slot name="actions" />
      </div>

      <div v-if="$slots.default" class="hero-section__extra">
        <slot />
      </div>
    </div>
  </header>
