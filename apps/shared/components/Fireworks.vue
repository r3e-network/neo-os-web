<template>
  <div v-if="active" class="fireworks-container" aria-hidden="true">
    <div v-for="i in 12" :key="i" :class="`firework firework-${i}`" :style="getFireworkStyle(i)">
      <div v-for="j in 8" :key="j" :class="`spark spark-${j}`" />
    </div>
  </div>
</template>
