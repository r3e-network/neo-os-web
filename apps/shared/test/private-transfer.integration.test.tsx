...
describe("private-transfer integration: dispatch params", () => {
  it("dispatches prepareTransfer only after the composer has valid inputs", async () => {
    ...
    const btn = container.querySelector(".pt-primary-action") as HTMLButtonElement;
    ...
    fireEvent.change(container.querySelector("input[placeholder='memoPlaceholder']") as Element, {
