...
const appMessages = {
  ...
  streamDetailsTab: { en: "Details", zh: "详情" },
  streamGuideTab: { en: "Guide", zh: "指南" },
  streamCreatedTab: { en: "Created", zh: "已创建" },
  streamReceivingTab: { en: "Receiving", zh: "待领取" },
  ...
  reviewStream: { en: "Draft release schedule", zh: "释放计划草稿" },
  enterDetails: { en: "Build ticket", zh: "生成票据" },
  streamTicket: { en: "Stream ticket", zh: "资金流票据" },
  ...
  releaseLinear: { en: "{amount} {token} per day", zh: "每日释放 {amount} {token}" },
  releaseCliff: { en: "{amount} {token} after {days} days", zh: "{days} 天后释放 {amount} {token}" },
  amountMode: { en: "Amount", zh: "金额" },
  routeMode: { en: "Route", zh: "路径" },
  scheduleMode: { en: "Schedule", zh: "计划" },
  amountModeHint: { en: "Pick the value to stream", zh: "选择要流式发放的金额" },
  routeModeHint: { en: "Choose the recipient route", zh: "选择收款路径" },
  scheduleModeHint: { en: "Shape the release timing", zh: "配置释放节奏" },
  routeModeEmpty: { en: "Recipient appears here once selected.", zh: "选择收款方后会显示在这里。" },
  customDays: { en: "Custom", zh: "自定义" },
  ...
  neoWholeUnitHint: { en: "NEO is indivisible; use whole-token amounts only.", zh: "NEO 最小单位是 1，只能使用整数金额。" },
  drawerDetailsSubtitle: {
    en: "Fine-tune exact values without crowding the main stream terminal.",
    zh: "在这里精确调整参数，主界面保持清晰聚焦。",
  },
  howItWorksTitle: { en: "How streaming payments work", zh: "流式支付如何工作" },
  howStep1: {
    en: "Shape the ticket with recipient, amount, and duration. GAS and NEO are supported.",
    zh: "用收款方、金额和周期生成票据。支持 GAS 和 NEO。",
  },
  howStep2: {
