...
const appMessages = {
    ...
    pullSuccess: { en: "Pull complete. Your prize is shown below.", zh: "抽取完成。奖品已在下方显示。" },
    gasboxClientPrizeNote: { en: "Prize resolved from the published odds. No automatic on-chain prize transfer occurs in this build.", zh: "奖品根据公开概率结算。此版本不会自动进行链上奖品转账。" },
  ...
  filterAll: { en: "All", zh: "全部" },
    ...
    createPanelHint: {
        en: "Published machines go straight to the market with their prize table; players pay GAS to pull and the prize resolves against these odds.",
        zh: "发布的机器会带着奖品表直接进入市场；玩家支付 GAS 抽取，奖品按这些概率结算。",
    },
