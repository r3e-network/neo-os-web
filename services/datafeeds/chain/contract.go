...
func NewDataFeedsContract(client *chain.Client, contractHash string, wallet *chain.Wallet) *DataFeedsContract {
...
func (d *DataFeedsContract) GetLatestPrice(ctx context.Context, feedID string) (*chain.PriceData, error) {
...
func (d *DataFeedsContract) GetFeedConfig(ctx context.Context, feedID string) (*chain.ContractFeedConfig, error) {
	params := []chain.ContractParam{chain.NewStringParam(feedID)}
