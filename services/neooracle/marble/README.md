...
| File | Purpose |
|------|---------|
| `service.go` | Service initialization, secrets client |
...
Fetches secrets from NeoStore service over mTLS:
...
type Config struct {
    ...
    SecretsHTTPClient *http.Client // optional: defaults to Marble mTLS
...
| `ServiceName` | `NeoNeoOracle Service` | Display name |
