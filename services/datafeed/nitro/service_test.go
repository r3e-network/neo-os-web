...
func TestGetPriceWithMockSources(t *testing.T) {
	...
	svc, _ := New(Config{Nitro: m, FeedsConfig: mockConfig, HTTPClient: &http.Client{}})
...
func TestGetPriceNoSources(t *testing.T) {
	...
	svc, _ := New(Config{Nitro: m, FeedsConfig: emptyConfig})
...
func TestGetPriceAllSourcesFail(t *testing.T) {
	...
	svc, _ := New(Config{Nitro: m, FeedsConfig: failConfig, HTTPClient: &http.Client{}})
...
func TestFetchPriceSuccess(t *testing.T) {
	...
	m, _ := nitro.New(nitro.Config{NitroType: "neofeeds"})
	svc, _ := New(Config{Nitro: m, HTTPClient: &http.Client{}})
