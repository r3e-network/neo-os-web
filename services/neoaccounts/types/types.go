...
// - the neoaccounts server implementation (`services/neoaccounts/marble`)
// - service-to-service clients (`services/neoaccounts/client`)
// - other services consuming the API (e.g. NeoVault)
package types
