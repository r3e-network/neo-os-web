  ...
  <NeoCard variant="erobo-neo">
    <div class="form-group">
      <div class="input-group">
        <span class="input-label">{{ t("identitySeed") }}</span>
        <NeoInput v-model="modelValue.identitySeed" :placeholder="t('identityPlaceholder')" />
      </div>
      <div class="input-group">
        <span class="input-label">{{ t("maskTypeLabel") }}</span>
        <div class="mask-type-actions">
          <NeoButton
            size="sm"
      ...
      <div v-if="identityHash" class="hash-preview">
        <span class="hash-label">{{ t("hashPreview") }}</span>
        <span class="hash-value">{{ identityHash }}</span>
      </div>
      ...
      <span class="helper-text">{{ t("maskFeeNote") }}</span>
    </div>
  </NeoCard>
</template>
