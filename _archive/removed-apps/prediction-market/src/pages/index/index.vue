    ...
    <template #tab-portfolio>
      <div class="portfolio-summary">
        <div class="summary-card">
          <span class="summary-label">{{ t("portfolioValue") }}</span>
          <span class="summary-value">{{ formatCurrency(portfolioValue) }} GAS</span>
        </div>
        <div class="summary-card" :class="{ positive: totalPnL > 0, negative: totalPnL < 0 }">
          <span class="summary-label">{{ t("totalPnL") }}</span>
          <span class="summary-value">{{ totalPnL > 0 ? "+" : "" }}{{ formatCurrency(totalPnL) }} GAS</span>
        </div>
      </div>
