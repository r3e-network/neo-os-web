  ...
  >
    <div class="panel-badges">
      <div class="panel-badge">
        <span>{{ t("txNetwork") }}: Neo N3</span>
      </div>
      <div class="panel-badge">
        <span>{{ t("txContract") }}: {{ t("txContractValue") }}</span>
      </div>
    </div>

    <div class="workflow-strip">
      <div class="workflow-step active"
        ><span>{{ t("workflowStepConfig") }}</span></view
      >
      <div class="workflow-step"
        ><span>{{ t("workflowStepReview") }}</span></view
      >
      <div class="workflow-step"
        ><span>{{ t("workflowStepSign") }}</span></view
      >
    </div>
    ...
    <template #actions>
      <span class="panel-footnote">{{ t("txFootnote") }}</span>
    </template>
  </FormCard>
</template>
