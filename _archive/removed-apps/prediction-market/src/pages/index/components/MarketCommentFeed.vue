<template>
  <div class="content-card">
    <div class="feed-tabs" role="tablist" :aria-label="`${t('commentsTab')} / ${t('reviewsTab')}`">
      <div
        :id="commentsTabId"
        class="feed-tab"
    ...
    >
      <div class="comment-composer">
        ...
        <button class="publish-button" :disabled="!canPublishComment" @click="publishComment">
          <span>{{ t("publishComment") }}</span>
        </button>
      </div>

      <div class="comment-list">
        <div v-for="comment in commentFeed" :key="comment.id" class="comment-item">
    ...
    <div v-else :id="reviewsPanelId" class="review-panel" role="tabpanel" :aria-labelledby="reviewsTabId">
      <div v-if="reviewFeed.length === 0" class="empty-state">
        <span>{{ t("noReviewsYet") }}</span>
      </div>
      <div v-else class="review-list">
        <div v-for="review in reviewFeed" :key="review.id" class="review-item">
