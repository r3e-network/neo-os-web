<template>
  <div class="content-card">
    <div class="section-row">
      <span class="section-title">{{ t("yourOrders") }}</span>
      <span class="section-count">{{ marketOrders.length }}</span>
    </div>
      ...
      <template #item="{ item }">
        <div class="order-item">
          <div class="order-main">
            <span class="order-type" :class="(item as unknown as ViewOrder).orderType">
    ...
    <div class="positions-section">
      <div class="section-row">
        <span class="section-title">{{ t("yourPositions") }}</span>
        <span class="section-count">{{ marketPositions.length }}</span>
      </div>
      ...
      >
        ...
        <template #item="{ item }">
          <div class="position-item">
            <span class="position-outcome">{{ (item as unknown as MarketPosition).outcome.toUpperCase() }}</span>
