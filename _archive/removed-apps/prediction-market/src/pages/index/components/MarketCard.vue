<template>
  ...
  >
    <div class="market-header">
      <div class="market-category">{{ getCategoryLabel(market.category) }}</div>
    ...
    <div class="market-prices">
      <div class="price-row yes">
        <span class="price-label">{{ t("yesShares") }}</span>
        <span class="price-value">{{ formatPrice(market.yesPrice) }}</span>
      </div>
      <div class="price-row no">
        <span class="price-label">{{ t("noShares") }}</span>
        <span class="price-value">{{ formatPrice(market.noPrice) }}</span>
      </div>
    </div>

    <div class="market-footer">
      <div class="market-volume">
        <span class="volume-label">{{ t("totalVolume") }}:</span>
        <span class="volume-value">{{ formatVolume(market.totalVolume) }} GAS</span>
      </div>
