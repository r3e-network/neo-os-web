<template>
  <NeoCard variant="erobo" class="trust-document-card">
    <div class="official-banner">{{ t("officialTrust") }}</div>

    <!-- Document Header -->
    <div class="document-header">
      <div class="document-seal">
        <span class="seal-icon">{{ trust.icon }}</span>
        <span class="seal-text">{{ t("sealed") }}</span>
      </div>
      <div class="document-status" :class="trust.status">
        <span class="status-dot">●</span>
        <span class="status-text">{{ t(trust.status) }}</span>
      </div>
    </div>

    <!-- Trust Title -->
    <div class="document-title">
      <span class="title-text">{{ trust.name }}</span>
      <span class="title-subtitle">{{ t("trustDocument") }}</span>
    </div>
    ...
    <div class="document-footer">
      <span class="footer-text">{{ t("documentId") }}: {{ trust.id }}</span>
      <span class="footer-signature">✍️ {{ t("digitalSignature") }}</span>
    </div>
  </NeoCard>
</template>
