<template>
  <NeoCard variant="erobo" class="security-dashboard-glass">
    ...
    <div class="shield-container">
      <div class="shield-ring" :class="securityLevelClass"></div>
      <div class="shield-core">🛡️</div>
      <div class="shield-pulse" :class="securityLevelClass"></div>
    </div>

    <div class="security-info">
      <span class="security-label">{{ t("securityLevel") }}</span>
      <span :class="['security-value', securityLevelClass]">{{ securityLevel }}</span>
    </div>

    <div class="security-meter-glass">
      <div class="meter-bar-glass" :style="{ width: securityPercentage + '%' }" :class="securityLevelClass">
