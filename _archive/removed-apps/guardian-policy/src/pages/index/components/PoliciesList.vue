  ...
  <NeoCard class="policies-card" variant="erobo">
    <ItemList :items="policies" item-key="id">
      <template #item="{ item: policy }">
        <div class="policy-item-glass" :class="[policy.level, { disabled: !policy.active }]">
          <div class="level-stripe" :class="policy.level"></div>

          <div class="policy-content">
            <div class="policy-header">
              <span class="policy-name">{{ policy.name }}</span>
              <div class="level-badge" :class="policy.level">{{ getLevelText(policy.level) }}</div>
              <div class="status-badge" :class="{ active: policy.active, claimed: policy.claimed }">
          ...
          <div class="policy-action">
            ...
            <span v-else class="policy-status">{{ policy.claimed ? t("claimed") : t("expired") }}</span>
          </div>
        </div>
      </template>
    </ItemList>
