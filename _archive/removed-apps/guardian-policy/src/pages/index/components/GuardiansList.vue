  ...
  <NeoCard class="guardians-card" variant="erobo">
    <ItemList :items="guardians" item-key="id">
      <template #item="{ item: guardian }">
        <div class="guardian-item-glass">
          <div class="guardian-avatar-wrapper">
            <div class="guardian-avatar">{{ guardian.avatar }}</div>
            <div class="avatar-ring" :class="{ active: guardian.active }"></div>
          </div>
          ...
          <div class="guardian-status">
            <div class="status-indicator" :class="{ active: guardian.active }">
              <div class="status-pulse" v-if="guardian.active"></div>
