  ...
  >
    ...
    <template #content>
      ...
      <div class="campaign-list">
        <div v-if="loadingCampaigns" class="loading-state" role="status" aria-live="polite">
          <span>{{ t("loading") }}</span>
        </div>
        <div v-else-if="filteredCampaigns.length === 0" class="empty-state" role="status">
          <span>{{ t("noCampaigns") }}</span>
        </div>
        <CampaignCard
          v-else
