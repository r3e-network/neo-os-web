<template>
  ...
  >
    ...
    <!-- Category -->
    <div class="form-field">
      <span class="field-label">{{ t("selectCategory") }} *</span>
    ...
    <!-- Target Goal -->
    <div class="form-field">
      <span class="field-label">{{ t("targetGoal") }} *</span>
      <input
    ...
    <div class="form-field">
      ...
      <div class="duration-input">
        ...
        />
        <span class="duration-suffix">{{ t("durationDays") }}</span>
      </div>
    </div>

    <!-- Beneficiary Address -->
    <div class="form-field">
      <span class="field-label">{{ t("beneficiaryAddress") }} *</span>
      <input v-model="formData.beneficiary" class="field-input" :placeholder="t('beneficiaryPlaceholder')" />
    </div>

    <!-- Multi-sig Addresses -->
    <div class="form-field">
      <span class="field-label">{{ t("multisigAddresses") }}</span>
      <span class="field-hint">{{ t("multisigInfo") }}</span>
      <div v-for="(addr, index) in formData.multisigAddresses" :key="index" class="multisig-row">
        <input
