<template>
  <div v-if="visible" class="game-splash" :class="{ 'splash-exit': exit }">
    <div class="splash-content">
      <div class="logo-container">
        <div class="turtle-glow" />
        <TurtleSprite :color="TurtleColor.Gold" matched size="lg" />
      </div>
      
      <div class="title-container">
        <span class="game-name">{{ t("splashTitle") }}</span>
        <span class="game-subtitle">{{ t("splashSubtitle") }}</span>
      </div>
