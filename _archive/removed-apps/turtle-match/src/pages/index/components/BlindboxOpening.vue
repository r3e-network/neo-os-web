<template>
  <div v-if="visible" class="blindbox-opening">
    <div class="blindbox-opening__backdrop" />
    
    <!-- Cyber Capsule -->
    <div :class="['capsule-container', { 'capsule-container--opening': isOpening }]">
      <div class="capsule">
        <div class="capsule-top">
          <div class="capsule-rim" />
          <!-- Holographic Scanner -->
        ...
        <div class="capsule-core">
          <span class="core-text">{{ t("neoSymbol") }}</span>
        </div>
      </div>
      
      <!-- Energy Beam & Holographic Projection -->
      <div v-if="isOpening" class="projection-beam" />
      <div v-if="isOpening" class="energy-beam" />
    </div>

    <!-- Reveal Area -->
    <div v-if="showTurtle" class="blindbox-opening__reveal">
      <div class="reveal-glow" :style="{ '--glow-color': turtleColorHex }" />
      <TurtleSprite :color="turtleColor" size="lg" />
    </div>

    <!-- UI Particles -->
    <div v-if="isOpening" class="blindbox-opening__particles">
      <div v-for="i in 16" :key="i" class="blindbox-opening__particle" />
    </div>
  </div>
</template>
