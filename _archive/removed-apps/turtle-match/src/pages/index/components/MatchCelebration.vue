<template>
  <div v-if="visible" class="match-celebration">
    <div class="match-celebration__backdrop" :style="{ '--celebration-color': turtleColorHex }" />

    <!-- Light Rays -->
    <div class="light-rays">
      <div v-for="i in 12" :key="i" class="ray" :style="{ '--angle': (i * 30) + 'deg' }" />
    </div>

    <!-- Matched turtles -->
    <div class="match-view">
      <div class="match-turtle left">
        <TurtleSprite :color="turtleColor" matched size="lg" />
      </div>
      <div class="match-text">{{ t("matchLabel") }}</div>
      <div class="match-turtle right">
        <TurtleSprite :color="turtleColor" matched size="lg" />
      </div>
    </div>
    ...
    <div class="reward-card">
      <span class="reward-title">{{ t("rewardLabel") }}</span>
      <div class="reward-amount">
        <span class="amount-val">+{{ formattedReward }}</span>
    ...
    <div class="fx-layer">
      <!-- Sparkles -->
      <div v-for="i in 15" :key="'s' + i" class="sparkle" />
      <!-- Coins -->
      <div v-for="i in 10" :key="'c' + i" class="flying-coin">
