<template>
  ...
  >
    <template #content>
      <!-- Wallet Prompt -->
      <div v-if="!address && activeTab === 'game'" class="wallet-prompt-container">
      ...
      <div v-if="unscratchedTickets.length > 0" class="mb-6 px-1" aria-live="polite">
        <NeoCard variant="accent" class="border-gold">
          <div class="flex items-center justify-between">
            <div>
              <span class="mb-1 text-lg font-bold">{{ t("ticketsWaiting") }}</span>
