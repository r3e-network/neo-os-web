<template>
  <NeoCard variant="erobo-neo">
    ...
    <span class="upload-subtitle mb-6 block text-center opacity-70">{{ t("uploadSubtitle") }}</span>
    ...
    <NeoInput
      ...
      class="mb-2"
    />
    <div class="hash-note-glass mb-6">
      <span class="hash-note-text">🔒 {{ t("hashNote") }}</span>
    </div>
    ...
    <div class="category-select mb-4">
      <span class="category-label mb-2 block">{{ t("category") }}</span>
