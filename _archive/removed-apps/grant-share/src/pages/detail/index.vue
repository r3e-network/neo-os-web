<template>
  <ResponsiveLayout :desktop-breakpoint="1024" class="theme-grant-share">
    <div class="app-container">
      ...
      <div v-else-if="grant" class="grant-detail">
        <NeoCard variant="erobo-neo" class="mb-4">
          <div class="header-section">
            <span class="grant-title-glass">{{ grant.title }}</span>
            <div class="meta-row mt-2">
              <span class="grant-creator-glass">{{ t("by") }} {{ grant.proposer }}</span>
        ...
        <NeoCard variant="erobo-neo" class="mb-4">
          <div class="section-title-glass">{{ t("details") }}</div>
          <div class="description-content">
            <span class="desc-text">{{ grant.description || t("noDescription") }}</span>
          </div>
        </NeoCard>

        <NeoCard variant="erobo-neo" class="mb-4">
          <div class="section-title-glass">{{ t("voting") }}</div>
...
onMounted(() => { /* route params via URL query */ }); // was onLoad((options: Record<string, string> | undefined) => {
