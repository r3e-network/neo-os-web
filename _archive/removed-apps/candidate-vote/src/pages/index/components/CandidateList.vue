<template>
  <NeoCard variant="erobo-neo" class="candidate-list-card">
    ...
    >
      <template #empty>
        <div class="empty-state">
          ...
          <span class="empty-text">{{ t("noCandidates") }}</span>
        </div>
      </template>
        ...
        >
          ...
          <div class="candidate-info">
            <div class="name-row">
              ...
              <div v-if="isUserVotedCandidate(item as unknown as GovernanceCandidate)" class="your-vote-badge">
                <span class="your-vote-text">{{ t("yourVote") }}</span>
              </div>
            </div>
          ...
          <div class="candidate-votes">
            <span class="votes-value">{{ formatVotes((item as unknown as GovernanceCandidate).votes) }}</span>
            <span class="votes-label">{{ t("votes") }}</span>
          </div>
          ...
          <div class="action-buttons">
            ...
            <div class="info-btn" @click.stop="viewDetails(item as unknown as GovernanceCandidate, index)">
    ...
    <div v-if="totalVotes" class="total-votes-footer">
      <span class="total-label">{{ t("totalNetworkVotes") }}:</span>
      <span class="total-value">{{ formatVotes(totalVotes) }}</span>
    </div>
  </NeoCard>
</template>
