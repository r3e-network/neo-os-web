<template>
  <div :class="['mobile-container', isEmbedded && 'embedded']">
    <div class="aspect-wrapper">
      <div class="app-layout" role="application" aria-label="Application layout">
        <TopNavBar v-if="showTopNav" :title="title ?? ''" :show-back="showBack" @back="handleBack" />
        <div :class="['app-content', !allowScroll && 'no-scroll']" role="main" :tabindex="allowScroll ? -1 : 0">
          <slot />
        </div>
        <NavBar
