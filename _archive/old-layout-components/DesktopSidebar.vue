<template>
  <div class="sidebar" role="navigation" aria-label="Main navigation">
    ...
    <div class="sidebar-header">
      ...
      <span class="brand-tagline">Miniapps</span>
    </div>
    ...
    <div class="sidebar-nav" role="tablist" aria-label="Navigation tabs">
      ...
      >
        ...
        <div v-if="activeTab === tab.id" class="nav-indicator" aria-hidden="true" />
      </div>
    </div>

    <div v-if="hasSidebarSlot" class="sidebar-panel" role="complementary" aria-label="Sidebar details">
    ...
    <div class="sidebar-footer">
      <div class="footer-status" role="status" aria-live="polite">
        <div class="status-dot online" aria-hidden="true" />
