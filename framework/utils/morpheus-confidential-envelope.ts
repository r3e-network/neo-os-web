/**
 * Morpheus confidential-payload envelope (X25519-HKDF-SHA256-AES-256-GCM).
 *
 * Canonical home of the helpers formerly duplicated between
 * apps/shared/utils/morpheus-confidential-envelope.ts and the framework
 * fork — shared re-exports from here.
 */
