...
{
    /// <summary>
    /// MiniAppMergeKingdom — settled through the generic Morpheus kernel: the
    ...
    /// (deposit-then-act, memo "miniapp-merge-kingdom:entry"); startGame consumes the entry
    ...
    /// </summary>
    [DisplayName("MiniAppMergeKingdom")]
    [ManifestExtra("Author", "R3E Network")]
    [ManifestExtra("Email", "dev@r3e.network")]
    [ManifestExtra("Version", "3.0.0")]
    [ManifestExtra("Description", "Merge kingdom settled through the generic Morpheus oracle kernel: run sealed in the TEE, kernel-verified finalize result, target-tile payout, penalized undos, pull-payment winnings.")]
    ...
    public partial class MiniAppMergeKingdom : SmartContract
    {
        ...
        {
            if (d == 0) return 30_000;
            if (d == 1) return 60_000;
            return 120_000;
        }
