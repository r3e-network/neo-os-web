...
{
    /// <summary>
    /// MiniAppPetPotion — settled through the generic Morpheus kernel: the
    ...
    /// (deposit-then-act, memo "miniapp-pet-potion:entry"); startGame consumes the entry
    ...
    /// </summary>
    [DisplayName("MiniAppPetPotion")]
    [ManifestExtra("Author", "R3E Network")]
    [ManifestExtra("Email", "dev@r3e.network")]
    [ManifestExtra("Version", "3.0.0")]
    [ManifestExtra("Description", "Pet potion mixer settled through the generic Morpheus oracle kernel: run sealed in the TEE, kernel-verified finalize result, target-happiness payout, penalized undos, pull-payment winnings.")]
    ...
    public partial class MiniAppPetPotion : SmartContract
    {
