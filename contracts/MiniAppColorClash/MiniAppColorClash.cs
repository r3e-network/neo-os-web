...
{
    /// <summary>
    /// MiniAppColorClash — settled through the generic Morpheus kernel: the
    ...
    /// (deposit-then-act, memo "miniapp-color-clash:entry"); startGame consumes the entry
    ...
    /// </summary>
    [DisplayName("MiniAppColorClash")]
    [ManifestExtra("Author", "R3E Network")]
    [ManifestExtra("Email", "dev@r3e.network")]
    [ManifestExtra("Version", "3.0.0")]
    [ManifestExtra("Description", "Colour-sequence memory settled through the generic Morpheus oracle kernel: run sealed in the TEE, kernel-verified finalize result, target-sequence payout, penalized undos, pull-payment winnings.")]
    ...
    public partial class MiniAppColorClash : SmartContract
    {
