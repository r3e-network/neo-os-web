...
namespace NeoMiniAppPlatform.Contracts
{
    public partial class MiniAppSheepSolitaire
    {
        ...
        /// <summary>The registered TEE session signer (compressed secp256r1), or null when unset.</summary>
        [Safe]
        ...
        /// <summary>The network magic the settlement digests pin (external verifier aid).</summary>
        [Safe]
        ...
        /// <summary>Static game configuration (base units / ms / card types).</summary>
        [Safe]
        public static Map<string, object> GetConfig()
        {
            ...
            r["targetCardTypes0"] = TargetCardTypesOf(0);
            r["targetCardTypes1"] = TargetCardTypesOf(1);
            r["targetCardTypes2"] = TargetCardTypesOf(2);
            r["maxLayers0"] = MaxLayersOf(0);
            r["maxLayers1"] = MaxLayersOf(1);
            r["maxLayers2"] = MaxLayersOf(2);
