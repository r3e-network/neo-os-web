...
{
    public partial class MiniAppFlappyDash
    {
        #region Read-only
        ...
        public static Map<string, object> GetGame(BigInteger gameId)
        {
            ...
            r["payout"] = g.Payout;
            r["solveMs"] = g.SolveMs;
            r["stateHash"] = ToHex(g.AnswerHash);
            r["pipesPassed"] = g.Score;
            return r;
        }
        ...
        public static Map<string, object> GetConfig()
        {
            ...
            r["targetPipes0"] = TargetScoreOf(0);
            r["targetPipes1"] = TargetScoreOf(1);
            r["targetPipes2"] = TargetScoreOf(2);
