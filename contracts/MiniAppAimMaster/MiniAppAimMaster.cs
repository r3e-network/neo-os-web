...
{
    /// <summary>
    /// MiniAppAimMaster — settled through the generic Morpheus kernel: the
    ...
    /// (deposit-then-act, memo "miniapp-aim-master:entry"); startGame consumes the entry
    ...
    /// </summary>
    [DisplayName("MiniAppAimMaster")]
    [ManifestExtra("Author", "R3E Network")]
    [ManifestExtra("Email", "dev@r3e.network")]
    [ManifestExtra("Version", "3.0.0")]
    [ManifestExtra("Description", "Aim trainer settled through the generic Morpheus oracle kernel: run sealed in the TEE, kernel-verified finalize result, accuracy-scaled payout, pull-payment winnings.")]
    ...
    public partial class MiniAppAimMaster : SmartContract
    {
        ...
        {
            if (d == 0) return 60_000;
            if (d == 1) return 90_000;
            return 120_000;
        }
        ...
        [DisplayName("Solved")]
        public static event Action<BigInteger, UInt160, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger> OnSolved; // gameId, player, difficulty, elapsedMs, ringsHit, payout, totalWon
