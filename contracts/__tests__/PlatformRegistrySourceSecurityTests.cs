...
namespace NeoMiniAppPlatform.Contracts.Tests
{
    ...
    public class PlatformRegistrySourceSecurityTests
    {
        ...
        public void ContractPermissions_AreNarrow()
        {
            ...
            Assert.Contains("[ContractPermission(\"*\", \"activateApp\", \"validateAndApplyDescriptor\", \"bindRegistry\", \"onAdminRotated\", \"executeTransfer\", \"setPaused\", \"update\", \"computePlatformAccountId\", \"registerPlatformAccount\", \"computeStablePlatformAccountId\", \"registerStablePlatformAccount\", \"rotatePlatformAccountOwner\", \"getPlatformRegistrar\")]", core);
        }
