...
{
    /// <summary>
    /// MiniAppGame2048 — settled through the generic Morpheus kernel: the
    ...
    /// (deposit-then-act, memo "miniapp-game-2048:entry"); startGame consumes the entry
    ...
    /// </summary>
    [DisplayName("MiniAppGame2048")]
    [ManifestExtra("Author", "R3E Network")]
    [ManifestExtra("Email", "dev@r3e.network")]
    [ManifestExtra("Version", "3.0.0")]
    [ManifestExtra("Description", "Timed 2048 settled through the generic Morpheus oracle kernel: run sealed in the TEE, kernel-verified finalize result, penalized undos, pull-payment winnings.")]
    ...
    public partial class MiniAppGame2048 : SmartContract
    {
        ...
        {
            if (d == 0) return 240_000;
            if (d == 1) return 480_000;
            return 900_000;
        }
