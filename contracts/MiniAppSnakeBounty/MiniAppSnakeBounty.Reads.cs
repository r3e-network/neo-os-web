...
{
    public partial class MiniAppSnakeBounty
    {
        #region Read-only
        ...
        public static Map<string, object> GetConfig()
        {
            ...
            r["targetLength0"] = TargetScoreOf(0);
            r["targetLength1"] = TargetScoreOf(1);
            r["targetLength2"] = TargetScoreOf(2);
