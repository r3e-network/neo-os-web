...
{
    /// <summary>
    /// MiniAppSnakeBounty — settled through the generic Morpheus kernel: the
    ...
    /// (deposit-then-act, memo "miniapp-snake-bounty:entry"); startGame consumes the entry
    ...
    /// </summary>
    [DisplayName("MiniAppSnakeBounty")]
    [ManifestExtra("Author", "R3E Network")]
    [ManifestExtra("Email", "dev@r3e.network")]
    [ManifestExtra("Version", "3.0.0")]
    [ManifestExtra("Description", "Snake bounty settled through the generic Morpheus oracle kernel: run sealed in the TEE, kernel-verified finalize result, target-length payout, pull-payment winnings.")]
    ...
    public partial class MiniAppSnakeBounty : SmartContract
    {
