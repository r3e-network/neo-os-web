...
deploy_contract "FundingVault"
deploy_contract "StreamVesting"
deploy_contract "PriceFeed"
deploy_contract "RandomnessLog"
deploy_contract "AppRegistry"
deploy_contract "AutomationAnchor"
deploy_contract "StorageService"
deploy_contract "PaymentService"
deploy_contract "ScriptEngine"
deploy_contract "CheckinService"
deploy_contract "BadgeService"
deploy_contract "LeaderboardService"
deploy_contract "VestingService"
deploy_contract "GameService"
deploy_contract "EscrowService"
deploy_contract "NFTService"
...
echo "  go run -tags=scripts ./deploy/scripts/register_modular_instance.go --plan deploy/config/modular-neopay.shared.example.json --validate-only"
echo "  go run -tags=scripts ./deploy/scripts/register_modular_instance.go --plan deploy/config/modular-neopay.shared.example.json --dry-run"
