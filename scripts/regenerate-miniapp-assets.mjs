...
const PLANNED_ATLASES = [
  ...
  {
    file: "scripts/miniapp-asset-sources/planned-atlas-06.png",
    cols: 4,
    rows: 2,
    slugs: [
      "neo-x-bridge",
...
const CATEGORY_BY_SLUG = {
  ...
  "neo-x-bridge": "defi",
  "neodid-passport": "data",
  "oracle-compute-lab": "data",
  "oracle-http-console": "data",
  "oracle-neodid-console": "data",
  explorer: "data",
  "oracle-price-console": "data",
  "oracle-seal-console": "data",
  "oracle-vrf-console": "data",
