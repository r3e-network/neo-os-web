...
PASS
ok  	github.com/r3e-network/neo-miniapp-platform/infrastructure/security	0.002s
```
...
... (16 tests total)
PASS
ok  	github.com/r3e-network/neo-miniapp-platform/infrastructure/middleware	2.264s
```
