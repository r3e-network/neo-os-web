...
3. **Missing Governance Composable** (HIGH)
   - File: `miniapps/packages/@neo/uniapp-sdk/src/composables/`
...
| miniapps app manifests    | 62    | ⚠️ MISMATCH |
...
| 21  | Cross     | Entry URL Scheme Divergence        | MEDIUM   | miniapps/apps/              |
...
miniapps/packages/@neo/uniapp-sdk/src/composables/ # Governance composable
```
