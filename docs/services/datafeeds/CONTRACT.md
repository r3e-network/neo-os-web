# datafeeds Service Smart Contract Documentation

## Overview

The datafeeds service smart contract provides on-chain integration for the datafeeds service on the Neo N3 blockchain.

## Contract Information

- **Contract Name**: DatafeedsService
- **Language**: C# (Neo N3)
