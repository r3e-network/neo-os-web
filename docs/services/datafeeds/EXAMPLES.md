# datafeeds Service Usage Examples
...
```bash
curl -X POST http://localhost:8080/api/datafeeds/request \
...
```typescript
import { DatafeedsClient } from '@r3e/service-layer-sdk';

const client = new DatafeedsClient({
...
func main() {
    client := client.NewDatafeedsClient(
...
{
    private static readonly UInt160 DatafeedsService = 
...
- [datafeeds Service README](./README.md)
