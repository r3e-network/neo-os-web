# ccip Service Smart Contract Documentation

## Overview

The ccip service smart contract provides on-chain integration for the ccip service on the Neo N3 blockchain.

## Contract Information

- **Contract Name**: CcipService
- **Language**: C# (Neo N3)
...
{
    private static readonly UInt160 CcipService = 
