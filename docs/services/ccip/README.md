...
Cross-Chain Interoperability Protocol service for multi-chain communication
...
Service ID: ccip
Version: 1.0.0
Description: Cross-Chain Interoperability Protocol service for multi-chain communication
