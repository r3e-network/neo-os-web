# confidential Service Usage Examples
...
```bash
curl -X POST http://localhost:8080/api/confidential/request \
...
func main() {
    client := client.NewConfidentialClient(
...
- [confidential Service README](./README.md)
