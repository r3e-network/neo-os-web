# confidential Service Smart Contract Documentation

## Overview

The confidential service smart contract provides on-chain integration for the confidential service on the Neo N3 blockchain.

## Contract Information

- **Contract Name**: ConfidentialService
- **Language**: C# (Neo N3)
...
{
    private static readonly UInt160 ConfidentialService = 
