# cre Service Smart Contract Documentation

## Overview

The cre service smart contract provides on-chain integration for the cre service on the Neo N3 blockchain.

## Contract Information

- **Contract Name**: CreService
- **Language**: C# (Neo N3)
...
Submit a request to the cre service.
...
{
    private static readonly UInt160 CreService = 
