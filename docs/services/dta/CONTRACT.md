# dta Service Smart Contract Documentation

## Overview

The dta service smart contract provides on-chain integration for the dta service on the Neo N3 blockchain.

## Contract Information

- **Contract Name**: DtaService
- **Language**: C# (Neo N3)
