...
```bash
curl -X POST http://localhost:8080/api/dta/request \
...
```typescript
import { DtaClient } from '@r3e/service-layer-sdk';

const client = new DtaClient({
...
{
    private static readonly UInt160 DtaService = 
