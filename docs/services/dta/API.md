...
**Endpoint**: `GET /services/dta/status`
...
Submit a request to the dta service.

**Endpoint**: `POST /dta/request`
...
client := client.NewDtaClient("http://localhost:8080/api", "your-api-key")
