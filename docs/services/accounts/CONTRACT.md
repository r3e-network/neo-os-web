# accounts Service Smart Contract Documentation

## Overview

The accounts service smart contract provides on-chain integration for the accounts service on the Neo N3 blockchain.

## Contract Information

- **Contract Name**: AccountsService
- **Language**: C# (Neo N3)
