# automation Service Smart Contract Documentation

## Overview

The automation service smart contract provides on-chain integration for the automation service on the Neo N3 blockchain.

## Contract Information

- **Contract Name**: AutomationService
- **Language**: C# (Neo N3)
...
Submit a request to the automation service.
...
{
    private static readonly UInt160 AutomationService = 
