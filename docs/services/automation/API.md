# automation Service API Documentation
...
**Endpoint**: `GET /services/automation/status`
...
**Endpoint**: `POST /automation/request`
...
```typescript
import { AutomationClient } from '@r3e/service-layer-sdk';
...
client := client.NewAutomationClient("http://localhost:8080/api", "your-api-key")
