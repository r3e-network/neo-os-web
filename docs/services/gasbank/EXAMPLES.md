# gasbank Service Usage Examples
...
```bash
curl -X POST http://localhost:8080/api/gasbank/request \
...
```typescript
import { GasbankClient } from '@r3e/service-layer-sdk';

const client = new GasbankClient({
...
func main() {
    client := client.NewGasbankClient(
...
{
    private static readonly UInt160 GasbankService = 
...
- [gasbank Service README](./README.md)
