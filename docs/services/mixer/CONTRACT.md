# mixer Service Smart Contract Documentation

## Overview

The mixer service smart contract provides on-chain integration for the mixer service on the Neo N3 blockchain.

## Contract Information

- **Contract Name**: MixerService
- **Language**: C# (Neo N3)
...
{
    private static readonly UInt160 MixerService = 
