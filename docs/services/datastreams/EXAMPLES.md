# datastreams Service Usage Examples
...
```bash
curl -X POST http://localhost:8080/api/datastreams/request \
...
func main() {
    client := client.NewDatastreamsClient(
...
- [datastreams Service README](./README.md)
