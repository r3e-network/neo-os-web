# datalink Service API Documentation
...
**Endpoint**: `GET /services/datalink/status`
...
**Endpoint**: `POST /datalink/request`
...
client := client.NewDatalinkClient("http://localhost:8080/api", "your-api-key")
