# datalink Service Usage Examples
...
```bash
curl -X POST http://localhost:8080/api/datalink/request \
...
```typescript
import { DatalinkClient } from '@r3e/service-layer-sdk';
...
func main() {
    client := client.NewDatalinkClient(
...
- [datalink Service README](./README.md)
