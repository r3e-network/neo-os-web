# datalink Service Smart Contract Documentation

## Overview

The datalink service smart contract provides on-chain integration for the datalink service on the Neo N3 blockchain.

## Contract Information

- **Contract Name**: DatalinkService
- **Language**: C# (Neo N3)
...
Submit a request to the datalink service.
...
{
    private static readonly UInt160 DatalinkService = 
