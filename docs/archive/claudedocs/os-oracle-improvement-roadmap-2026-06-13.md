...
**Key file references:** OS — `/Users/jinghuiliao/git/r3e/neo-os-web/platform/host-app/{pages/miniapps/[id].tsx, components/playarea/PlayAreaShared.tsx, lib/wallet/adapters/wif.ts, lib/miniapp-invoke/recipes.ts}`, `platform/admin-console/src/app/templates/page.tsx`. Oracle — `/Users/jinghuiliao/git/r3e/neo-morpheus-oracle/workers/morpheus-relayer/src/{fulfillment.js, neo-n3.js, config.js}`, `workers/nitro-worker/src/oracle/feeds.js`, `apps/web/lib/onchain-state.ts`.