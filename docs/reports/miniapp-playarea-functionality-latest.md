...
Generated: 2026-07-25T11:33:54.579Z

## Summary

- Total active miniapps: 78
- UI workflow surface present: 78
- Needs follow-up: 0
...
- profiled host + embedded real dApp: 52
...
| --- | --- | --- | --- | ---: | ---: | --- | --- | --- | --- |
| miniapp-aa-account-lab | profiled host + embedded real dApp | yes | yes | 7 | 9 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, wallet-write-intent, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-aa-session-key-lab | profiled host + embedded real dApp | yes | yes | 14 | 21 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, wallet-write-intent, action-handlers, interactive-controls | usable-surface-present |
| miniapp-aim-master | profiled host + embedded real dApp | yes | yes | 9 | 24 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, live-api-call, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-bead-workshop | profiled host + embedded real dApp | yes | yes | 4 | 19 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-burn-league | profiled host + embedded real dApp | yes | yes | 8 | 15 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, registered-actions, host-embeds-real-dapp, wallet-write-intent, manifest-operations, action-handlers, interactive-controls | usable-surface-present |
| miniapp-color-clash | profiled host + embedded real dApp | yes | yes | 11 | 25 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-flappy-dash | profiled host + embedded real dApp | yes | yes | 13 | 27 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-fruit-funnel | profiled host + embedded real dApp | yes | yes | 6 | 20 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, action-handlers, interactive-controls | usable-surface-present |
| miniapp-game-2048 | profiled host + embedded real dApp | yes | yes | 10 | 23 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-gomoku | profiled host + embedded real dApp | yes | yes | 4 | 13 | local_preview | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-graveyard | profiled host + embedded real dApp | yes | yes | 24 | 41 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, wallet-write-intent, file-upload, action-handlers, interactive-controls | usable-surface-present |
| miniapp-jump-rush | profiled host + embedded real dApp | yes | yes | 13 | 21 | local_preview | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, action-handlers, interactive-controls | usable-surface-present |
| miniapp-last-survivor | custom native playarea | yes | yes | 10 | 21 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, wallet-write-intent, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-neo-message | profiled host + embedded real dApp | yes | yes | 10 | 8 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, registered-actions, host-embeds-real-dapp, wallet-write-intent, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-pet-potion | profiled host + embedded real dApp | yes | yes | 9 | 19 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, wallet-write-intent, action-handlers, interactive-controls | usable-surface-present |
| miniapp-private-transfer | custom native playarea | yes | yes | 10 | 5 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-redenvelope | custom native playarea | yes | yes | 12 | 32 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, registered-actions, host-embeds-real-dapp, live-api-call, wallet-write-intent, manifest-operations, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-sheep-solitaire | profiled host + embedded real dApp | yes | yes | 19 | 62 | local_preview | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, action-handlers, interactive-controls | usable-surface-present |
| miniapp-snake-bounty | profiled host + embedded real dApp | yes | yes | 6 | 29 | wallet_intent | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, wallet-write-intent, action-handlers, interactive-controls | usable-surface-present |
...
| miniapp-zhuada-e | profiled host + embedded real dApp | yes | yes | 55 | 51 | local_preview | local_preview | built-static-dapp, standalone-playarea, host-embeds-real-dapp, live-api-call, action-handlers, interactive-controls | usable-surface-present |
